...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("SELECT password FROM bloodboked_users WHERE email = ?");
    if (!$stmt) {
...
<header class="header">
    ...
    <div class="header-bottom" data-header>
      <div class="container">
        ...
        <a href="preblodbok.php" class="btn">Login / Booking</a>
      ...
      <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png'); margin: 0%;"
        ...
        <div class="container">
          <div class="form-container">
            <div class="form-title">BookingLogin</div>
            <hr><br><br>
            <form action="" method="POST">
              ...
              <button type="submit" class="btn">BookingLogin</button>
            </form><br><br>
            <div class="form-title">Not Booked? <u><a href="preblodbok.php" style="display: inline; color: #216aca;" onmouseover="this.style.color='#03d9ff'" onmouseout="this.style.color='#216aca'">Blood_Booking Here</a></u></div>
          </div>
      ...
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li>
            <a href="#" class="footer-link">
              <ion-icon name="add-outline"></ion-icon>
              <span class="span">Login /Blood-Booking </span>
            </a>
          </li>
        </ul>
        <ul class="footer-list">
