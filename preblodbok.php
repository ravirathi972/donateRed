...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $needbloodgroup = isset($_POST["needblood_group"]) ? htmlspecialchars($_POST["needblood_group"]) : "";
    $bookeddate = isset($_POST["booked_date"]) ? htmlspecialchars($_POST["booked_date"]) : "";
    ...
    $stmt = $conn->prepare("INSERT INTO bloodboked_users (name,phone,email,password,state,district,zipcode,area,landmark, needbloodgroup,bookeddate) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    if (!$stmt) {
        die("Error: " . $conn->error);
    }
    $stmt->bind_param("sssssssssss", $name,$phone, $email,$hashedPassword,$state,$district,$zipcode,$area,$landmarks, $needbloodgroup,$bookeddate);
    if ($stmt->execute()) {
        echo '<script>alert("Blood-booked successful!");</script>';
    } else {
        echo '<script>alert("Error: Unable to booked. Please try again later.");</script>';
    }
    $stmt->close();
    $conn->close();
}
...
<head>
  ...
  <title>Donate Red - connect the donors</title>
...
<body id="top">
  ...
  <header class="header">
    ...
    <div class="header-bottom" data-header>
      <div class="container">
        <a href="#" class="logo">Donate Red</a>
        ...
        <a href="preblodbok.php" class="btn">Blood Book</a>
  ...
  <main>
    <article>
        <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png'); margin: 0%;" aria-label="hero">
            <!-- Login and Prebloodbooked Form -->
            <div class="container">
              <div class="form-container">
                <div class="form-title">Blood Book</div>
                <form action="#" method="POST">
                  ...
                  <div class="form-section">
                    <div class="form-field">
                      <label for="blood-group">NEED BLOOD GROUP</label>
                    ...
                    <div class="form-field">
                      ...
                      <input type="date" id="booked-date" name="booked_date" required>
                    </div>
                    
                 
                  <button type="submit" class="btn">Blood Book</button>
                </form>
                <div class="form-title">Already Booked?<u><a href="BookingLogin.php" style="display: inline; color: #216aca;" onmouseover="this.style.color='#03d9ff'" onmouseout="this.style.color='#216aca'">BloodBookingLogin Here</a></u></div>
              </div>
      ...
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li>
            <a href="#" class="footer-link">
              <ion-icon name="add-outline"></ion-icon>
              <span class="span">Blood Book</span>
            </a>
          </li>
        </ul>
        <ul class="footer-list">
