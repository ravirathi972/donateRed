      ...
      <div class="container">
        <ul class="contact-list">
          ...
          <li class="contact-item">
            ...
            <a href="tel:+917558951351" class="contact-link">+91-9034405780 | +91-7404153152</a>
          </li>
        </ul>
        <ul class="social-list">
        
          <li>
            <a href="https://www.instagram.com/donate_red_/" class="social-link">
    ...
    <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png')"
        ...
        <div class="container">
          <div class="hero-content">
            ...
            <p class="section-subtitle">Donate Red </p>
            ...
            Panipat, Haryana, IN<br>
            Pin 132103
            </p>
            <h2 style="color: var(--royal-blue-light);">Contact Details</h2>
            <p class="hero-text">
            MOBILE: +91 90344-05780 |  74041-53152 |<br>
            EMAIL : donatered185@gmail.com<br>
            </p>
            
          </div>
          <figure class="hero-banner">
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d516.7087599832125!2d76.97242605496865!3d29.39989681047383!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1692465883475!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </figure>
        </div>
    </section>
      ...
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            ...
            <a href="https://goo.gl/maps/uh2q8Zjtr9VkvVuw8">
          ...
          <li class="footer-item">
            ...
            <a href="tel:+91-90344-05780" class="footer-link">+91-9034405780 | +91-7404153152</a>
          </li>
          <li class="footer-item">
            <div class="item-icon">
              <ion-icon name="mail-outline"></ion-icon>
